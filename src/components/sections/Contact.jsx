  ...
  return (
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
            ...
            <h2 className="text-lg lg:text-5xl font-normal text-white mb-4">
            Let's Work Together
            </h2>
        ...
        <FadeIn delay={100}>
            ...
            <button
                type="submit"
                className="w-full px-6 py-3 bg-linear-to-r from-primary/10 to-primary text-white font-medium rounded-xl hover:shadow-2xl hover:shadow-primary/30 transition-all duration-300 items-center justify-center gap-2 group"
                >
        ...
        {/* Contact Info */}
            ...
            <div className="space-y-4">
                ...
                <p className="text-white/60 leading-relaxed">
                    I'm always open to discussing new projects, creative ideas, or opertunities is to be part of your vision. Feel free to reach out
                </p>
                </div>

                <div className="space-y-4">
                <div className="group relative bg-white/5 border-white/5 border border-white/10 rounded-2xl hover:border-primary/30 transition-all duration-300">
