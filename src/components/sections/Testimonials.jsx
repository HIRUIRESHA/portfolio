...
const Testimonials = () => {
  ...
  const prevTestimonial = () => {
    // Ensures the index wraps around correctly even with negative numbers
              ...
              <div className="flex flex-col md:flex-row gap-6 items-stretch">
                ...
                <div className="flex items-center justify-center gap-2 mt-10">
                    ...
                    <button
                        ...
                        className="flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 lg:translate-x-4 items-center justify-center w-10 h-10 lg:w-10 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 z-10"
