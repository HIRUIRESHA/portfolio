...
const About = () => {
    //skills
    const skills = [
        {name: "React.js", icon: SiReact, colors: "#61DAFB"},
        {name: "Next.js", icon: SiNextdotjs, colors: "#000000"},
        {name: "TypeScript", icon: SiTypescript, colors: "#3178C6"},
        {name: "Tailwind CSS", icon: SiTailwindcss, colors: "#06B6D4"},
        {name: "Node.js", icon: SiNodedotjs, colors: "#339933"},
        {name: "MongoDB", icon: SiMongodb, colors: "#47A248"},
    ];
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2 relative group">
                                ...
                                <div className="p-3 bg-primary/10 rounded-xl">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-white/70 leading-relaxed">
                                            Specialized in building scalable web applications with modern technologies & best practices.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative group">
                            <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                            <div className="relative bg-white/5 border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                                    ...
                                    <h3 className="text-base font-semibold text-white mb-2">Claen Code</h3>
                                    <p className="text-sm text-white/70 leading-relaxed">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300"></div>
                                <div className="relative  border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                    <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
                        ...
                        <div
                            ...
                            >
                                ...
                                {/*hover glow effect*/}
                                <div className="absolute inset-0 bg-linear-to-br from-primary/0 group-hover:to-primary/10 rounded-2xl transition-all duration-300"></div>
                                </div>
                        ))}
                    </div>
                </div>
