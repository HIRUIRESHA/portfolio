...
export const SOCIAL_LINKS = 
    {
        github: 'https://github.com/hiruni-iresha',
        linkedin: 'https://www.linkedin.com/in/hiruni-iresha/',
        twitter: 'https://twitter.com/hiruni_iresha'
...
export const STATS = [
    ...
    { label: 'clients satisfaction', value: '5+' }
];
